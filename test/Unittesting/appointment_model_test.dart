...
void main() {
  test(
      ...
      () {
      //ARRANGE
      Appointment testAppointment = Appointment(id: "1", start: DateTime.utc(1999,10,10));
      //ACT
      var result = testAppointment.toString();
      //ASSERT
       expect(result, "Appointment 1 1999-10-10 00:00:00.000Z");
    
  });

  test('Given the function Appointment.fromJson when a Json with the identifier start, then the function returns an appointment with the data from the json as start value', () {
    //ARRANGE
    Map<String, dynamic> json = {'start':15000};
    //ACT
